...
import '../assets/styles/LiquidBackground.css';
...
interface LiquidBackgroundWebGL {
...
export default function LiquidBackground({
  ...
  const webglRef = useRef<LiquidBackgroundWebGL | null>(null);
...
`;
    ...
    class WebGLManager implements LiquidBackgroundWebGL {
      props: any;
      output!: Output;
  ...
  return <div ref={mountRef} className={`liquid-background-container ${className || ''}`} style={style} />;
}
